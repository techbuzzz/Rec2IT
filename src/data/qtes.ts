...
const JUNIOR_QTES: QTE[] = [
  ...
  {
    id: 'junior-spot-extra',
    type: 'spot-bug',
    prompt: 'Найди баг: CSS typo',
    flavor: 'Классика Junior Frontend. Соберись.',
    code: 'function juniorFunc() {\n  return null.length\n}',
    bugRegions: [{ start: 26, end: 36, reason: 'null.length → TypeError' }],
    duration: 6000,
    perfectScore: 50,
    okScore: 25,
    failPenalty: -10,
  ...
  {
    id: 'junior-pick-extra',
    type: 'single-choice',
    prompt: 'Какой паттерн для Junior Frontend?',
    flavor: 'Best practice для Junior Frontend.',
    options: [
      { id: 'a', label: 'Singleton', correct: false },
      { id: 'b', label: 'Factory', correct: true },
      { id: 'c', label: 'Observer', correct: false },
    ],
    duration: 5000,
    perfectScore: 40,
    okScore: 20,
  ...
  {
    id: 'junior-hold-extra',
    type: 'hold',
    prompt: 'Удерживай действие',
    flavor: 'Концентрация — ключ к успеху.',
    action: '⏱️ Focus',
    holdMs: 1800,
    okTolerance: 450,
    duration: 4000,
  ...
  {
    id: 'junior-order-extra',
    type: 'sequence',
    prompt: 'Порядок: CSS typo',
    flavor: 'Правильная последовательность.',
    correctOrder: ['step1', 'step2', 'step3', 'step4'],
    items: [
      { id: 'step1', label: '1️⃣ Step 1' },
      { id: 'step2', label: '2️⃣ Step 2' },
      { id: 'step3', label: '3️⃣ Step 3' },
      { id: 'step4', label: '4️⃣ Step 4' },
    ],
    duration: 10000,
    perfectScore: 55,
    okScore: 25,
  ...
  {
    id: 'junior-slider-extra',
    type: 'slider',
    prompt: 'Выстави значение: 50',
    flavor: 'Точность важна.',
    metric: '🎚️ Value',
    target: 50,
    perfectTolerance: 5,
    okTolerance: 15,
...
const MIDDLE_QTES: QTE[] = [
  ...
  {
    id: 'middle-spot-extra',
    type: 'spot-bug',
    prompt: 'Найди баг: SQL injection',
    flavor: 'Классика Middle Backend. Соберись.',
    code: 'function middleFunc() {\n  return null.length\n}',
    bugRegions: [{ start: 26, end: 36, reason: 'null.length → TypeError' }],
    duration: 6000,
    perfectScore: 50,
    okScore: 25,
  ...
  {
    id: 'middle-pick-extra',
    type: 'single-choice',
    prompt: 'Какой паттерн для Middle Backend?',
    flavor: 'Best practice для Middle Backend.',
    options: [
      { id: 'a', label: 'Singleton', correct: false },
      { id: 'b', label: 'Factory', correct: true },
      { id: 'c', label: 'Observer', correct: false },
  ...
  {
    id: 'middle-order-extra',
    type: 'sequence',
    prompt: 'Порядок: SQL injection',
    flavor: 'Правильная последовательность.',
    correctOrder: ['step1', 'step2', 'step3', 'step4'],
    items: [
      { id: 'step1', label: '1️⃣ Step 1' },
...
const DEVOPS_QTES: QTE[] = [
  ...
  {
    id: 'devops-spot-extra',
    type: 'spot-bug',
    prompt: 'Найди баг: YAML misconfig',
    flavor: 'Классика DevOps. Соберись.',
    code: 'function devopsFunc() {\n  return null.length\n}',
    bugRegions: [{ start: 26, end: 36, reason: 'null.length → TypeError' }],
    duration: 6000,
    perfectScore: 50,
    okScore: 25,
  ...
  {
    id: 'devops-pick-extra',
    type: 'single-choice',
    prompt: 'Какой паттерн для DevOps?',
    flavor: 'Best practice для DevOps.',
    options: [
      { id: 'a', label: 'Singleton', correct: false },
      { id: 'b', label: 'Factory', correct: true },
      { id: 'c', label: 'Observer', correct: false },
  ...
  {
    id: 'devops-order-extra',
    type: 'sequence',
    prompt: 'Порядок: YAML misconfig',
    flavor: 'Правильная последовательность.',
    correctOrder: ['step1', 'step2', 'step3', 'step4'],
    items: [
      { id: 'step1', label: '1️⃣ Step 1' },
...
const ML_QTES: QTE[] = [
  ...
  },
  {
    id: 'ml-spot-extra',
    type: 'spot-bug',
    prompt: 'Найди баг: model overfit',
    flavor: 'Классика ML Engineer. Соберись.',
    code: 'function mlFunc() {\n  return null.length\n}',
    bugRegions: [{ start: 26, end: 36, reason: 'null.length → TypeError' }],
    duration: 6000,
    perfectScore: 50,
    okScore: 25,
  ...
  },
  {
    id: 'ml-pick-extra',
    type: 'single-choice',
    prompt: 'Какой паттерн для ML Engineer?',
    flavor: 'Best practice для ML Engineer.',
    options: [
      { id: 'a', label: 'Singleton', correct: false },
      { id: 'b', label: 'Factory', correct: true },
      { id: 'c', label: 'Observer', correct: false },
...
const PM_QTES: QTE[] = [
  ...
  },
  {
    id: 'pm-spot-extra',
    type: 'spot-bug',
    prompt: 'Найди баг: sprint planning',
    flavor: 'Классика Product Manager. Соберись.',
    code: 'function pmFunc() {\n  return null.length\n}',
    bugRegions: [{ start: 26, end: 36, reason: 'null.length → TypeError' }],
    duration: 6000,
    perfectScore: 50,
    okScore: 25,
  ...
  },
  {
    id: 'pm-pick-extra',
    type: 'single-choice',
    prompt: 'Какой паттерн для Product Manager?',
    flavor: 'Best practice для Product Manager.',
    options: [
      { id: 'a', label: 'Singleton', correct: false },
      { id: 'b', label: 'Factory', correct: true },
      { id: 'c', label: 'Observer', correct: false },
  ...
  },
  {
    id: 'pm-order-extra',
    type: 'sequence',
    prompt: 'Порядок: sprint planning',
    flavor: 'Правильная последовательность.',
    correctOrder: ['step1', 'step2', 'step3', 'step4'],
    items: [
      { id: 'step1', label: '1️⃣ Step 1' },
...
const QA_QTES: QTE[] = [
  ...
  },
  {
    id: 'qa-spot-extra',
    type: 'spot-bug',
    prompt: 'Найди баг: flaky test',
    flavor: 'Классика QA Engineer. Соберись.',
    code: 'function qaFunc() {\n  return null.length\n}',
    bugRegions: [{ start: 26, end: 36, reason: 'null.length → TypeError' }],
    duration: 6000,
    perfectScore: 50,
    okScore: 25,
  ...
  },
  {
    id: 'qa-pick-extra',
    type: 'single-choice',
    prompt: 'Какой паттерн для QA Engineer?',
    flavor: 'Best practice для QA Engineer.',
    options: [
      { id: 'a', label: 'Singleton', correct: false },
      { id: 'b', label: 'Factory', correct: true },
      { id: 'c', label: 'Observer', correct: false },
...
const MOBILE_QTES: QTE[] = [
  ...
  {
    id: 'mobile-spot-extra',
    type: 'spot-bug',
    prompt: 'Найди баг: iOS memory leak',
    flavor: 'Классика Mobile Developer. Соберись.',
    code: 'function mobileFunc() {\n  return null.length\n}',
    bugRegions: [{ start: 26, end: 36, reason: 'null.length → TypeError' }],
    duration: 6000,
    perfectScore: 50,
    okScore: 25,
  ...
  {
    id: 'mobile-pick-extra',
    type: 'single-choice',
    prompt: 'Какой паттерн для Mobile Developer?',
    flavor: 'Best practice для Mobile Developer.',
    options: [
      { id: 'a', label: 'Singleton', correct: false },
      { id: 'b', label: 'Factory', correct: true },
      { id: 'c', label: 'Observer', correct: false },
  ...
  {
    id: 'mobile-order-extra',
    type: 'sequence',
    prompt: 'Порядок: iOS memory leak',
    flavor: 'Правильная последовательность.',
    correctOrder: ['step1', 'step2', 'step3', 'step4'],
    items: [
      { id: 'step1', label: '1️⃣ Step 1' },
...
const SENIOR_QTES: QTE[] = [
  ...
  {
    id: 'senior-spot-extra',
    type: 'spot-bug',
    prompt: 'Найди баг: system design race',
    flavor: 'Классика Senior Full-Stack. Соберись.',
    code: 'function seniorFunc() {\n  return null.length\n}',
    bugRegions: [{ start: 26, end: 36, reason: 'null.length → TypeError' }],
    duration: 6000,
    perfectScore: 50,
    okScore: 25,
  ...
  {
    id: 'senior-pick-extra',
    type: 'single-choice',
    prompt: 'Какой паттерн для Senior Full-Stack?',
    flavor: 'Best practice для Senior Full-Stack.',
    options: [
      { id: 'a', label: 'Singleton', correct: false },
      { id: 'b', label: 'Factory', correct: true },
      { id: 'c', label: 'Observer', correct: false },
  ...
  {
    id: 'senior-order-extra',
    type: 'sequence',
    prompt: 'Порядок: system design race',
    flavor: 'Правильная последовательность.',
    correctOrder: ['step1', 'step2', 'step3', 'step4'],
    items: [
      { id: 'step1', label: '1️⃣ Step 1' },
